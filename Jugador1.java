...
public class Jugador1 extends Jugadores
{
    ...
    {
        coordPly1 = getX();
        //System.out.println("coordenada player1: "+coordPly1);
        //System.out.println("coordenada player2: "+coordPly2);
        //puedo poner el nombre de la clase seguido de la variable, sin antes haber instanciado la clase antes ej:(Jugadores x = new Jugadores();)
        //solo si la variable de jugadores es estática, sino, toca instanciarla.
        //La variable se estableció con el identificador estático, ya que al utilizarla en esta clase empieza con su valor por defecto 0. y no el modificado por el getX.
        //esto es porque la variables y métodos marcados con identificador static, pertenecen a la clase directamente y no a la instancia de dicha clase.
        ...
        if(Greenfoot.isKeyDown("d") && (PunioDebilOn==false && PunioFuerteOn==false && PatadaDebilOn==false && PatadaFuerteOn==false) )
        ...
        if(Greenfoot.isKeyDown("a") && (PunioDebilOn==false && PunioFuerteOn==false && PatadaDebilOn==false && PatadaFuerteOn==false) )        
        {
        ...
        if(Greenfoot.isKeyDown("d") && cuenta == 0)
        ...
        if(!Greenfoot.isKeyDown("d") && cuenta == 1 )
        {
          cuenta = 2;
        }        

        if(Greenfoot.isKeyDown("d") && cuenta ==2)
        {          
          AnimCorrer(); 
        ...
        if(!Greenfoot.isKeyDown("d") && pass == true)
        {            //como pass ya cambia a true después de correr y soltar la tecla d entonces quita el aumento de velocidad.
            Player1.setVelocidadMov(Player1.getVelocidadMov() - 10);
            cuenta = 0;
            pass = false;            
        }        
        if(!Greenfoot.isKeyDown("d")) //esto empezará a contar desde q toca la tecla, para tener un rango de tiempo en q se pueda correr.
        {
           reseteoRun ++;
        ...
        if(Greenfoot.isKeyDown("s") && (ColisionSuelo()==true || getY() ==415) )
        { 
            AnimAgacharse();
        ...
        if(!Greenfoot.isKeyDown("s")  && siSeAgacho == true && getY() ==415 )
        {
            
            FotogramaD = 0;            
        }
        
        if(!Greenfoot.isKeyDown("s")  && (!Greenfoot.isKeyDown("w") && ColisionSuelo() ) )
        {
        ...
        if(Greenfoot.isKeyDown("w") && ColisionSuelo() == true && PermisoSalto==true)//añadir de condición el suelo, para saltar solo si está en el suelo.
        {
        ...
        if(!Greenfoot.isKeyDown("w") && getY() ==415 )
        {PermisoSalto=true;}
        ...
        if(Greenfoot.isKeyDown("u") && (PunioFuerteOn==false && PatadaDebilOn==false && PatadaFuerteOn==false) )
        {
            PunioDebilOn = true;            
        }        
        ...
        //Puño Fuerte
        if(Greenfoot.isKeyDown("k") && (PunioDebilOn== false && PatadaDebilOn==false && PatadaFuerteOn==false))
        {
            PunioFuerteOn = true;
        }        
        ...
        if(Greenfoot.isKeyDown("i") && (PunioDebilOn== false && PunioFuerteOn==false && PatadaFuerteOn==false) )
        {
            PatadaDebilOn = true;
        }        
        ...
        if(Greenfoot.isKeyDown("j") && (PunioDebilOn== false && PunioFuerteOn==false && PatadaDebilOn==false) )
        {
            PatadaFuerteOn = true;
        }        
    ...
    int FotogramaM=0;
    public void AnimPatadaFuerte() //Animación puño Fuerte.
    {
            FotogramaM ++;
            if(FotogramaM == 3){
